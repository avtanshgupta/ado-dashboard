...
import {
  ...
  Search, Bell, PartyPopper, ChevronLeft, ChevronRight, X,
} from './icons.jsx';
...
const STEPS = [
  {
    ...
    body: 'This quick tour shows where everything lives — configuring repos, reviewing pull requests, and running pipelines. It takes about a minute.',
  },
  {
    key: 'dashboard',
    route: '/',
    ...
    body: 'Start here each day to see what needs you: pull requests awaiting your vote, your own open PRs, and what you merged recently.',
  },
  {
    key: 'action-center',
    route: '/action-center',
    ...
    Icon: Zap,
    title: 'Action Center',
    body: 'A single prioritized inbox of everything that needs action — ordered by urgency, with staleness flags so nothing slips through.',
  },
  {
    key: 'pull-requests',
    route: '/pull-requests',
    ...
    Icon: GitPullRequest,
    title: 'Viewing pull requests',
    body: 'Browse PRs you created, ones assigned to you or your team, and an Overview with analytics. Use the tabs at the top to switch between buckets.',
  },
  {
    key: 'handle-prs',
    ...
    anchor: 'pr-subtabs',
    Icon: GitMerge,
    title: 'Handling a PR end-to-end',
  ...
  },
  {
    ...
    body: 'Find any PR or pipeline instantly. Press ⌘K (Ctrl-K) anywhere to open the command palette and navigate entirely by keyboard.',
  },
  {
    key: 'notifications',
    ...
    body: 'The bell lights up when something you care about changes — new votes, comments, or finished builds. You can also enable browser push and email digests in Settings.',
  },
  {
    key: 'settings',
    route: '/settings',
    anchor: 'settings-repos',
    Icon: SettingsIcon,
    title: 'Configure your workspace',
    body: 'Begin here: add the repositories to track from any project — just paste a repo URL and the name and project are filled in automatically. Repos and pipelines from every project show together in the same lists. You can also add pipelines, your team, reviewer-group aliases, notification preferences, and your staleness SLA.',
  },
  {
    key: 'finish',
    Icon: PartyPopper,
    title: 'You’re all set!',
    body: 'That’s the whole app. A great first step is adding your repositories in Settings. You can replay this tour anytime from the profile menu.',
    finishTo: '/settings',
