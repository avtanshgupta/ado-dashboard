...
import {
  ...
  Search, Menu, Sun, Moon, Monitor, LogOut, Zap, ChevronsLeft, ChevronsRight, Compass, ClipboardList, Bot, TriangleAlert, X, ListTodo, LineChart,
} from './icons.jsx';
...
const NAV = [
  ...
  { to: '/insights', Icon: LineChart, label: 'Insights', tour: 'insights' },
